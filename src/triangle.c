...
/* #define PI 3.141592653589793238462643383279502884197169399375105820974944592308  This is defined in R.h below*/
...
/* CHANGE TO SOURCE: For portability, in particular compilation of
   ...
   From file RTriangle/src/triangle.c in the RTriangle package.*/
...
#define decode(ptr, otri)                                                     \
  (otri).orient = (int) ((uintptr_t) (ptr) & (unsigned long) 3l);         \
  (otri).tri = (triangle *)                                                   \
                  ((uintptr_t) (ptr) ^ (unsigned long) (otri).orient)
...
#define encode(otri)                                                          \
  (triangle) ((uintptr_t) (otri).tri | (unsigned long) (otri).orient)
...
#define infect(otri)                                                          \
  (otri).tri[6] = (triangle)                                                  \
                    ((uintptr_t) (otri).tri[6] | (unsigned long) 2l)
...
#define infected(otri)                                                        \
  (((uintptr_t) (otri).tri[6] & (unsigned long) 2l) != 0l)
...
#define sdecode(sptr, osub)                                                   \
  (osub).ssorient = (int) ((uintptr_t) (sptr) & (unsigned long) 1l);      \
  (osub).ss = (subseg *)                                                      \
              ((uintptr_t) (sptr) & ~ (unsigned long) 3l)
...
#define sencode(osub)                                                         \
  (subseg) ((uintptr_t) (osub).ss | (unsigned long) (osub).ssorient)
...
#ifdef CDT_ONLY
#ifdef REDUCED
  Rprintf("triangle [-pAcjevngBPNEIOXzo_lQVh] input_file\n");
#else /* not REDUCED */
  Rprintf("triangle [-pAcjevngBPNEIOXzo_iFlCQVh] input_file\n");
#endif /* not REDUCED */
#else /* not CDT_ONLY */
#ifdef REDUCED
  Rprintf("triangle [-prq__a__uAcDjevngBPNEIOXzo_YS__lQVh] input_file\n");
#else /* not REDUCED */
  Rprintf("triangle [-prq__a__uAcDjevngBPNEIOXzo_YS__iFlsCQVh] input_file\n");
#endif /* not REDUCED */
#endif /* not CDT_ONLY */

  Rprintf("    -p  Triangulates a Planar Straight Line Graph (.poly file).\n");
#ifndef CDT_ONLY
  Rprintf("    -r  Refines a previously generated mesh.\n");
  Rprintf(
    "    -q  Quality mesh generation.  A minimum angle may be specified.\n");
  Rprintf("    -a  Applies a maximum triangle area constraint.\n");
  Rprintf("    -u  Applies a user-defined triangle constraint.\n");
#endif /* not CDT_ONLY */
  Rprintf(
    "    -A  Applies attributes to identify triangles in certain regions.\n");
  Rprintf("    -c  Encloses the convex hull with segments.\n");
#ifndef CDT_ONLY
  Rprintf("    -D  Conforming Delaunay:  all triangles are truly Delaunay.\n");
#endif /* not CDT_ONLY */
/*
  Rprintf("    -w  Weighted Delaunay triangulation.\n");
  Rprintf("    -W  Regular triangulation (lower hull of a height field).\n");
*/
  Rprintf("    -j  Jettison unused vertices from output .node file.\n");
  Rprintf("    -e  Generates an edge list.\n");
  Rprintf("    -v  Generates a Voronoi diagram.\n");
  Rprintf("    -n  Generates a list of triangle neighbors.\n");
  Rprintf("    -g  Generates an .off file for Geomview.\n");
  Rprintf("    -B  Suppresses output of boundary information.\n");
  Rprintf("    -P  Suppresses output of .poly file.\n");
  Rprintf("    -N  Suppresses output of .node file.\n");
  Rprintf("    -E  Suppresses output of .ele file.\n");
  Rprintf("    -I  Suppresses mesh iteration numbers.\n");
  Rprintf("    -O  Ignores holes in .poly file.\n");
  Rprintf("    -X  Suppresses use of exact arithmetic.\n");
  Rprintf("    -z  Numbers all items starting from zero (rather than one).\n");
  Rprintf("    -o2 Generates second-order subparametric elements.\n");
#ifndef CDT_ONLY
  Rprintf("    -Y  Suppresses boundary segment splitting.\n");
  Rprintf("    -S  Specifies maximum number of added Steiner points.\n");
#endif /* not CDT_ONLY */
#ifndef REDUCED
  Rprintf("    -i  Uses incremental method, rather than divide-and-conquer.\n");
  Rprintf("    -F  Uses Fortune's sweepline algorithm, rather than d-and-c.\n");
#endif /* not REDUCED */
  Rprintf("    -l  Uses vertical cuts only, rather than alternating cuts.\n");
#ifndef REDUCED
#ifndef CDT_ONLY
  Rprintf(
    "    -s  Force segments into mesh by splitting (instead of using CDT).\n");
#endif /* not CDT_ONLY */
  Rprintf("    -C  Check consistency of final mesh.\n");
#endif /* not REDUCED */
  Rprintf("    -Q  Quiet:  No terminal output except errors.\n");
  Rprintf("    -V  Verbose:  Detailed information on what I'm doing.\n");
  Rprintf("    -h  Help:  Detailed instructions for Triangle.\n");
  triexit(0);
}
...
"Copyright 1993, 1995, 1997, 1998, 2002, 2005 Jonathan Richard Shewchuk\n");
  Rprintf("2360 Woolsey #H / Berkeley, California 94705-1927\n");
  Rprintf("Bugs/comments to jrs@cs.berkeley.edu\n");
  Rprintf(
"Created as part of the Quake project (tools for earthquake simulation).\n");
  Rprintf(
"Supported in part by NSF Grant CMS-9318163 and an NSERC 1967 Scholarship.\n");
  Rprintf("There is no warranty whatsoever.  Use at your own risk.\n");
#ifdef SINGLE
  Rprintf("This executable is compiled for single precision arithmetic.\n\n\n");
#else /* not SINGLE */
  Rprintf("This executable is compiled for double precision arithmetic.\n\n\n");
#endif /* not SINGLE */
  Rprintf(
...
"and possibly a .poly file and an .area file as well.  The formats of these\n"
  ...
  Rprintf("files are described below.\n\n");
  Rprintf("Command Line Switches:\n\n");
  Rprintf(
...
"        triunsuitable().  In either case, the -u switch causes the user-\n");
  Rprintf("        defined test to be applied to every triangle.\n");
  Rprintf(
...
"        .poly file to be written containing the boundary edges of the mesh\n"
  ...
  Rprintf("        (useful if no .poly file was read).\n");
  Rprintf(
...
"    -g  Outputs the mesh to an Object File Format (.off) file, suitable for\n"
  ...
  Rprintf("        viewing with the Geometry Center's Geomview package.\n");
  Rprintf(
...
"        to maintain constraining segments on later refinements of the mesh.\n"
  ...
  Rprintf("    -N  No output .node file.\n");
  Rprintf("    -E  No output .ele file.\n");
  Rprintf(
...
"        using a .node file for input, because no .node file is written, so\n"
  ...
  Rprintf("        there is no record of any added Steiner points.\n");
  Rprintf("    -O  No holes.  Ignores the holes in the .poly file.\n");
  Rprintf(
...
"        improvement in speed and creates the possibility that Triangle will\n"
  ...
  Rprintf("        fail to produce a valid mesh.  Not recommended.\n");
  Rprintf(
...
"        always adds enough vertices to ensure that all the segments of the\n"
  ...
  Rprintf("        PLSG are recovered, ignoring the limit if necessary.\n");
  Rprintf(
...
"        construct a Delaunay triangulation.  Try it if the divide-and-\n");
  Rprintf("        conquer algorithm fails.\n");
  Rprintf(
...
"        triangulation.  Warning:  does not use exact arithmetic for all\n");
  Rprintf("        calculations.  An exact result is not guaranteed.\n");
  Rprintf(
...
"        prints so much that Triangle runs much more slowly.  `-VVVV' gives\n"
  ...
  Rprintf("        information only a debugger could love.\n");
  Rprintf("    -h  Help:  Displays these instructions.\n");
  Rprintf("\n");
  Rprintf("Definitions:\n");
  Rprintf("\n");
  Rprintf(
...
"  inside the circumscribing circle (circle that passes through all three\n");
  Rprintf("  vertices) of any triangle in the triangulation.\n\n");
  Rprintf(
...
"  to some input vertex than to any other input vertex.  The Voronoi diagram\n"
  ...
  Rprintf("  is a geometric dual of the Delaunay triangulation.\n\n");
  Rprintf(
...
"  Segments may intersect each other only at their endpoints.  The file\n");
  Rprintf("  format for PSLGs (.poly files) is described below.\n\n");
  Rprintf(
...
"  cover the convex hull of the PSLG, or it might cover only a segment-\n");
  Rprintf("  bounded region (e.g. a polygon).\n\n");
  Rprintf(
...
"  The new vertices are frequently necessary to maintain the Delaunay\n");
  Rprintf("  property while ensuring that every segment is represented.\n\n");
  Rprintf(
...
"  triangulation of a PSLG whose triangles are constrained Delaunay.  New\n");
  Rprintf("  vertices may appear, and input segments may be subdivided into\n");
  Rprintf(
...
"  by the -q switch are usually CCDTs, but can be made conforming Delaunay\n");
  Rprintf("  with the -D switch.\n\n");
  Rprintf("File Formats:\n\n");
  Rprintf(
...
"  another program, use the -z switch if you wish to number objects from\n");
  Rprintf("  zero.)  Examples of these file formats are given below.\n\n");
  Rprintf("  .node files:\n");
  Rprintf(
...
"    -a, -u, -D, or -s is selected, each new Steiner point added to the mesh\n"
  ...
  Rprintf("    has attributes assigned to it by linear interpolation.\n\n");
  Rprintf(
...
"    .node file produced by Triangle contains boundary markers in the last\n");
  Rprintf("    column unless they are suppressed by the -B switch.\n\n");
  Rprintf("  .ele files:\n");
  Rprintf(
...
"    around each triangle.  (The remaining nodes, if any, depend on the type\n"
  ...
  Rprintf("    of finite element used.)\n\n");
  Rprintf(
...
"    among nearby triangles as the triangulation is refined.  Attributes do\n"
  ...
  Rprintf("    not diffuse across segments, so attributes used to identify\n");
  Rprintf("    segment-bounded regions remain intact.\n\n");
  Rprintf(
...
"    Following lines:  <vertex #> <x> <y> [attributes] [boundary marker]\n");
  Rprintf("    One line:  <# of segments> <# of boundary markers (0 or 1)>\n");
  Rprintf(
"    Following lines:  <segment #> <endpoint> <endpoint> [boundary marker]\n");
  Rprintf("    One line:  <# of holes>\n");
  Rprintf("    Following lines:  <hole #> <x> <y>\n");
  Rprintf(
...
"    means that you must include its endpoints in the vertex list.  Each\n");
  Rprintf("    segment, like each point, may have a boundary marker.\n\n");
  Rprintf(
...
"    segment itself is also eaten.  Do not place a hole directly on a\n");
  Rprintf("    segment; if you do, Triangle chooses one side of the segment\n");
  Rprintf("    arbitrarily.\n\n");
  Rprintf(
...
"    simultaneously and wish to assign an attribute to some region without\n");
  Rprintf("    imposing an area constraint, use a negative maximum area.\n\n");
  Rprintf(
...
"    the segment, and you'll have a needle-sharp triangle in your output--or\n"
  ...
  Rprintf("    a lot of tiny triangles if you're generating a quality mesh.\n");
  Rprintf("\n");
  Rprintf(
...
"    mesh, and don't want segments to be missing in later triangulations.\n");
  Rprintf("\n");
  Rprintf("  .area files:\n");
  Rprintf("    First line:  <# of triangles>\n");
  Rprintf("    Following lines:  <triangle #> <maximum area>\n");
  Rprintf("\n");
  Rprintf(
...
"    triangle may be left unconstrained by assigning it a negative maximum\n");
  Rprintf("    area.\n\n");
  Rprintf("  .edge files:\n");
  Rprintf("    First line:  <# of edges> <# of boundary markers (0 or 1)>\n");
  Rprintf(
...
"    infinite ray with only one endpoint.  For these edges, a different\n");
  Rprintf("    format is used:\n\n");
  Rprintf("        <edge #> <endpoint> -1 <direction x> <direction y>\n\n");
  Rprintf(
"    The `direction' is a floating-point vector that indicates the direction\n"
);
  Rprintf("    of the infinite ray.\n\n");
  Rprintf("  .neigh files:\n");
  Rprintf(
...
"  finite element mesh.  You can prevent boundary markers from being written\n"
  ...
  Rprintf("  into files produced by Triangle by using the -B switch.\n\n");
  Rprintf(
"  The boundary marker associated with each segment in an output .poly file\n"
);
  Rprintf("  and each edge in an output .edge file is chosen as follows:\n");
  Rprintf(
...
"      (even the boundary of a hole), then the edge is assigned the marker\n");
  Rprintf("      one (1).\n");
  Rprintf("    - Otherwise, the edge is assigned the marker zero (0).\n");
  Rprintf(
"  The boundary marker associated with each vertex in an output .node file\n");
  Rprintf("  is chosen as follows:\n");
  Rprintf(
...
"      vertex is assigned the same marker.  If the vertex lies on several\n");
  Rprintf("      such segments, one of the markers is chosen arbitrarily.\n");
  Rprintf(
"    - Otherwise, if the vertex occurs on a boundary of the triangulation,\n");
  Rprintf("      then the vertex is assigned the marker one (1).\n");
  Rprintf("    - Otherwise, the vertex is assigned the marker zero (0).\n");
  Rprintf("\n");
  Rprintf(
...
"  all) in your input files.  In the output files, all boundary vertices,\n");
  Rprintf("  edges, and segments will be assigned the value one.\n\n");
  Rprintf("Triangulation Iteration Numbers:\n\n");
  Rprintf(
...
"  triangulation, and output the files mesh.4.node, mesh.4.ele, and\n");
  Rprintf("  mesh.4.poly.  Files with no iteration number are treated as if\n");
  Rprintf(
...
"  points, a .node file is written.  This can be quite convenient for\n");
  Rprintf("  computing CDTs or quality meshes.)\n\n");
  Rprintf("Examples of How to Use Triangle:\n\n");
  Rprintf(
...
"  mesh to object.1.node and object.1.ele.  Each segment may be broken up\n");
  Rprintf("  into multiple subsegments; these are written to object.1.poly.\n");
  Rprintf("\n");
  Rprintf(
...
"    # A box with eight vertices in 2D, no attributes, one boundary marker.\n"
  ...
  Rprintf("    8 2 0 1\n");
  Rprintf("     # Outer box has these vertices:\n");
  Rprintf("     1   0 0   0\n");
  Rprintf("     2   0 3   0\n");
  Rprintf("     3   3 0   0\n");
  Rprintf("     4   3 3   33     # A special marker for this vertex.\n");
  Rprintf("     # Inner square has these vertices:\n");
  Rprintf("     5   1 1   0\n");
  Rprintf("     6   1 2   0\n");
  Rprintf("     7   2 1   0\n");
  Rprintf("     8   2 2   0\n");
  Rprintf("    # Five segments with boundary markers.\n");
  Rprintf("    5 1\n");
  Rprintf("     1   1 2   5      # Left side of outer box.\n");
  Rprintf("     # Square hole has these segments:\n");
  Rprintf("     2   5 7   0\n");
  Rprintf("     3   7 8   0\n");
  Rprintf("     4   8 6   10\n");
  Rprintf("     5   6 5   0\n");
  Rprintf("    # One hole in the middle of the inner square.\n");
  Rprintf("    1\n");
  Rprintf("     1   1.5 1.5\n");
  Rprintf("\n");
  Rprintf(
...
"  other vertices but 4 have been marked to indicate that they lie on a\n");
  ...
  Rprintf("      11    3   1.5    1\n");
  Rprintf("      12    1.5   3    1\n");
  Rprintf("    # Generated by triangle -pqc box.poly\n");
  Rprintf("\n");
  Rprintf("  Here is the output file `box.1.ele', with twelve triangles.\n");
  Rprintf("\n");
  Rprintf("    12  3  0\n");
  Rprintf("       1     5   6   9\n");
  Rprintf("       2    10   3   7\n");
...
"  newly added vertices.  Note also that <# of vertices> is set to zero to\n");
  Rprintf("  indicate that the vertices should be read from the .node file.\n");
  Rprintf("\n");
  Rprintf("    0  2  0  1\n");
  Rprintf("    12  1\n");
  Rprintf("       1     1   9     5\n");
  ...
  Rprintf("    # Generated by triangle -pqc box.poly\n");
  Rprintf("\n");
  Rprintf("Refinement and Area Constraints:\n");
  Rprintf("\n");
  Rprintf(
...
"  consider instead using the -u switch and writing a C procedure that\n");
  Rprintf("  determines which triangles are too large.\n\n");
  Rprintf(
...
"  the nodes at the corners of an element; the midpoint nodes on each edge\n");
  Rprintf("  are discarded before the mesh is refined.\n\n");
  Rprintf(
...
"  are typically based on a posteriori error estimates resulting from a\n");
  Rprintf("  finite element simulation on that mesh.\n\n");
  Rprintf(
...
"  x.2' creates a sequence of successively finer meshes x.1, x.2, and x.3,\n");
  Rprintf("  suitable for multigrid.\n\n");
  Rprintf("Convex Hulls and Mesh Boundaries:\n\n");
  Rprintf(
...
"  There are faster algorithms for finding a two-dimensional convex hull\n");
  Rprintf("  than triangulation, of course, but this one comes for free.\n\n");
  Rprintf(
...
"  If you also use the -p switch, the output .poly file contains all the\n");
  Rprintf("  segments from the input .poly file as well.\n\n");
  Rprintf("Voronoi Diagrams:\n\n");
  Rprintf(
...
"  rays.  (The choice of filenames makes it easy to run the set of Voronoi\n");
  Rprintf("  vertices through Triangle, if so desired.)\n\n");
  Rprintf(
...
"  construct a conforming Delaunay triangulation instead of a CCDT, so the\n");
  Rprintf("  Voronoi diagram will be valid.\n\n");
  Rprintf("Mesh Topology:\n\n");
  Rprintf(
...
"  output files with the recollection that the Delaunay triangulation and\n");
  Rprintf("  the Voronoi diagram are planar duals.\n\n");
  Rprintf(
...
"  vertex j of the corresponding .v.node file.  Voronoi cell k is the dual\n");
  Rprintf("  of vertex k of the corresponding .node file.\n\n");
  Rprintf(
...
"  respectively.  To find which Voronoi cells are adjacent to each other,\n");
  Rprintf("  just read the list of Delaunay edges.\n\n");
  Rprintf(
...
"  Voronoi vertices attached to it.  You might find this more convenient\n");
  Rprintf("  than the .v.edge file.\n\n");
  Rprintf("Quadratic Elements:\n\n");
  Rprintf(
...
"  and sixth nodes appearing opposite the first, second, and third corners\n");
  Rprintf("  respectively.\n\n");
  Rprintf("Domains with Small Angles:\n\n");
  Rprintf(
...
"  is reduced to memory precision.  Triangle does this if it is compiled\n");
  Rprintf("  correctly.  See the makefile for details.\n\n");
  Rprintf(
...
"  inputs most likely to cause errors if you use the -X switch.  Hence, the\n"
  ...
  Rprintf("  -X switch is not recommended.\n\n");
  Rprintf(
...
"  files.)  Similarly, exact arithmetic is not used to compute the vertices\n"
  ...
  Rprintf("  of the Voronoi diagram.\n\n");
  Rprintf(
...
"  being performed exactly, while overflow typically causes a floating\n");
  Rprintf("  exception.\n\n");
  Rprintf("Calling Triangle from Another Program:\n\n");
  Rprintf("  Read the file triangle.h for details.\n\n");
  Rprintf("Troubleshooting:\n\n");
  Rprintf("  Please read this section before mailing me bugs.\n\n");
  Rprintf("  `My output mesh has no triangles!'\n\n");
  Rprintf(
...
"    have placed a hole badly, thereby eating all your triangles.  To test\n");
  Rprintf("    these possibilities, try again with the -c and -O switches.\n");
  Rprintf(
"    Alternatively, all your input vertices may be collinear, in which case\n"
);
  Rprintf("    you can hardly expect to triangulate them.\n\n");
  Rprintf("  `Triangle doesn't terminate, or just crashes.'\n\n");
  Rprintf(
...
"    between 6247133 and 6247134, you're not leaving much floating-point\n");
  Rprintf("    precision for Triangle to work with.\n\n");
  Rprintf(
...
"    above.)  Again, I recommend compiling Triangle for double (rather\n");
  Rprintf("    than single) precision arithmetic.\n\n");
  Rprintf(
...
"    extremely tiny triangles, or it might fail because of insufficient\n");
  Rprintf("    floating-point precision.\n\n");
  Rprintf(
...
"    don't use the -X switch.  If you still have problems, please report the\n"
  ...
  Rprintf(
"  `Triangle executes without incident, but when I look at the resulting\n");
  Rprintf("  Voronoi diagram, it has overlapping edges or other geometric\n");
  Rprintf("  inconsistencies.'\n");
  Rprintf("\n");
  Rprintf(
...
"    holes, and you use the -D switch to construct a conforming Delaunay\n");
  Rprintf("    triangulation (instead of a CDT or CCDT).\n\n");
  Rprintf(
...
"  doesn't, and you'll have to connect each adjacent pair of vertices with a\n"
  ...
  Rprintf("  separate segment.  If you don't like it, tough.\n\n");
  Rprintf(
...
"  endpoints, try not to let the intersections fall extremely close to PSLG\n"
  ...
  Rprintf("  vertices or each other.\n\n");
  Rprintf(
...
"  triangles constrained Delaunay?  Triangle's Delaunay refinement algorithm\n"
  ...
  Rprintf("  assumes that it starts with a CDT.\n\n");
  Rprintf("Show Me:\n\n");
  Rprintf(
...
"  you have the X Windows system.  Sorry, Microsoft Windows users.\n");
  Rprintf("\n");
  Rprintf("Triangle on the Web:\n");
  Rprintf("\n");
  Rprintf("  To see an illustrated version of these instructions, check out\n");
  Rprintf("\n");
  Rprintf("    http://www.cs.cmu.edu/~quake/triangle.html\n");
  Rprintf("\n");
  Rprintf("A Brief Plea:\n");
  Rprintf("\n");
  Rprintf(
...
"  you.  Also, I can put you on a list to receive email whenever a new\n");
  Rprintf("  version of Triangle is available.\n\n");
  Rprintf(
...
"  Schachter, Micha Sharir, Peter W. Shor, Daniel D. Sleator, Jorge Stolfi,\n"
  ...
  Rprintf("  Robert E. Tarjan, Alper Ungor, Christopher J. Van Wyk, Noel J.\n");
  Rprintf(
"  Walkington, and Binhai Zhu.  See the comments at the beginning of the\n");
  Rprintf("  source code for references.\n\n");
  triexit(0);
}
...
void internalerror()
{
  Rprintf("  Please report this bug to jrs@cs.berkeley.edu\n");
  Rprintf("  Include the message above, your input data set, and the exact\n");
  Rprintf("    command line you used to run Triangle.\n");
  triexit(1);
}
...
#define STARTINDEX 1
      ...
      for (j = STARTINDEX; argv[i][j] != '\0'; j++) {
        ...
        if (argv[i][j] == 'a') {
          ...
          if (((argv[i][j + 1] >= '0') && (argv[i][j + 1] <= '9')) ||
            ...
            if (b->maxarea <= 0.0) {
              Rprintf("Error:  Maximum area must be greater than zero.\n");
              triexit(1);
	    }
	  } else {
            b->vararea = 1;
  ...
  if (b->weighted && (b->poly || b->quality)) {
    b->weighted = 0;
    if (!b->quiet) {
      Rprintf("Warning:  weighted triangulations (-w, -W) are incompatible\n");
      Rprintf("  with PSLGs (-p) and meshing (-q, -a, -u).  Weights ignored.\n"
             );
    }
  }
  if (b->jettison && b->nonodewritten && !b->quiet) {
    Rprintf("Warning:  -j and -N switches are somewhat incompatible.\n");
    Rprintf("  If any vertices are jettisoned, you will need the output\n");
    Rprintf("  .node file to reconstruct the new node indices.");
  }
  ...
  if (b->noiterationnum) {
    ...
    sRprintf(b->outnodefilename, workstring, meshnumber + 1);
...

{
  ...
  Rprintf("triangle x%lx with orientation %d:\n", (uintptr_t) t->tri,
         t->orient);
  decode(t->tri[0], printtri);
  if (printtri.tri == m->dummytri) {
    Rprintf("    [0] = Outer space\n");
  } else {
  ...
  if (printvertex == (vertex) NULL)
    Rprintf("    Origin[%d] = NULL\n", (t->orient + 1) % 3 + 3);
  else
    Rprintf("    Origin[%d] = x%lx  (%.12g, %.12g)\n",
...

{
  ...
  Rprintf("subsegment x%lx with orientation %d and mark %d:\n",
         (uintptr_t) s->ss, s->ssorient, mark(*s));
  sdecode(s->ss[0], printsh);
  if (printsh.ss == m->dummysub) {
    Rprintf("    [0] = No subsegment\n");
  } else {
    Rprintf("    [0] = x%lx  %d\n", (uintptr_t) printsh.ss,
           printsh.ssorient);
  }
  ...
  if (printvertex == (vertex) NULL)
    Rprintf("    Segment origin[%d] = NULL\n", 4 + s->ssorient);
  else
    Rprintf("    Segment origin[%d] = x%lx  (%.12g, %.12g)\n",
           4 + s->ssorient, (uintptr_t) printvertex,
           printvertex[0], printvertex[1]);
  segdest(*s, printvertex);
  if (printvertex == (vertex) NULL)
    Rprintf("    Segment dest  [%d] = NULL\n", 5 - s->ssorient);
  else
    Rprintf("    Segment dest  [%d] = x%lx  (%.12g, %.12g)\n",
...

{
  ...
  b->noexact = 0;
  if (!b->quiet) {
    Rprintf("  Checking consistency of mesh...\n");
  }
  horrors = 0;
    ...
    for (triangleloop.orient = 0; triangleloop.orient < 3;
      ...
      if (oppotri.tri != m->dummytri) {
        ...
        if ((triangleloop.tri != oppooppotri.tri)
          ...
          Rprintf("  !! !! Asymmetric triangle-triangle bond:\n");
          if (triangleloop.tri == oppooppotri.tri) {
            Rprintf("   (Right triangle, wrong orientation)\n");
          }
          Rprintf("    First ");
          printtriangle(m, b, &triangleloop);
          Rprintf("    Second (nonreciprocating) ");
        ...
        if ((triorg != oppodest) || (tridest != oppoorg)) {
          Rprintf("  !! !! Mismatched edge coordinates between two triangles:\n"
                 );
          Rprintf("    First mismatched ");
          printtriangle(m, b, &triangleloop);
          Rprintf("    Second mismatched ");
          printtriangle(m, b, &oppotri);
          horrors++;
        }
      }
  ...
  if (horrors == 0) {
    if (!b->quiet) {
      Rprintf("  In my studied opinion, the mesh appears to be consistent.\n");
    }
  } else if (horrors == 1) {
    Rprintf("  !! !! !! !! Precisely one festering wound discovered.\n");
  } else {
    Rprintf("  !! !! !! !! %d abominations witnessed.\n", horrors);
  }
...

{
  ...
  b->noexact = 0;
  if (!b->quiet) {
    Rprintf("  Checking Delaunay property of mesh...\n");
  }
  horrors = 0;
  /* Run through the list of triangles, checking each one. */
  traversalinit(&m->triangles);
    ...
    for (triangleloop.orient = 0; triangleloop.orient < 3;
      ...
      if (shouldbedelaunay) {
        if (nonregular(m, b, triorg, tridest, triapex, oppoapex) > 0.0) {
          if (!b->weighted) {
            Rprintf("  !! !! Non-Delaunay pair of triangles:\n");
            Rprintf("    First non-Delaunay ");
            printtriangle(m, b, &triangleloop);
            Rprintf("    Second non-Delaunay ");
          } else {
            Rprintf("  !! !! Non-regular pair of triangles:\n");
            Rprintf("    First non-regular ");
            printtriangle(m, b, &triangleloop);
            Rprintf("    Second non-regular ");
          }
          printtriangle(m, b, &oppotri);
          horrors++;
        }
  ...
  "  By virtue of my perceptive intelligence, I declare the mesh Delaunay.\n");
    ...
    Rprintf("  !! !! !! !! %d obscenities viewed with horror.\n", horrors);
  }
  /* Restore the status of exact arithmetic. */
  b->noexact = saveexact;
}
...

{
  ...
  if (b->verbose > 2) {
    Rprintf("  Queueing bad triangle:\n");
    Rprintf("    (%.12g, %.12g) (%.12g, %.12g) (%.12g, %.12g)\n",
...

{
  ...
  if (b->verbose) {
    Rprintf("    Constructing mapping from vertices to triangles.\n");
  }
  traversalinit(&m->triangles);
  triangleloop.tri = triangletraverse(m);
  while (triangleloop.tri != (triangle *) NULL) {
...

{
  ...
  if (b->verbose > 2) {
    Rprintf("  Searching for point (%.12g, %.12g).\n",
  ...
  while (1) {
    if (b->verbose > 2) {
      Rprintf("    At (%.12g, %.12g) (%.12g, %.12g) (%.12g, %.12g)\n",
...

{
  ...
  if (b->verbose > 2) {
    Rprintf("  Randomly sampling for a triangle near point (%.12g, %.12g).\n",
           searchpoint[0], searchpoint[1]);
  }
  ...
  if (b->verbose > 2) {
    Rprintf("    Boundary triangle has origin (%.12g, %.12g).\n",
           torg[0], torg[1]);
  }
  ...
  if (m->recenttri.tri != (triangle *) NULL) {
    if (!deadtri(m->recenttri.tri)) {
      ...
      if (dist < searchdist) {
        ...
        searchdist = dist;
        if (b->verbose > 2) {
          Rprintf("    Choosing recent triangle with origin (%.12g, %.12g).\n",
                 torg[0], torg[1]);
        }
      }
    }
    ...
    do {
      ...
      if (!deadtri(sampletri.tri)) {
        ...
        if (dist < searchdist) {
          ...
          searchdist = dist;
          if (b->verbose > 2) {
            Rprintf("    Choosing triangle with origin (%.12g, %.12g).\n",
                   torg[0], torg[1]);
          }
        }
      }
...

{
  ...
  if (top.tri == m->dummytri) {
    Rprintf("Internal error in flip():  Attempt to flip on boundary.\n");
    lnextself(*flipedge);
    return;
  }
  if (m->checksegments) {
    ...
    if (toplsubseg.ss != m->dummysub) {
      Rprintf("Internal error in flip():  Attempt to flip a segment.\n");
      lnextself(*flipedge);
      return;
    }
  }
  ...
  if (b->verbose > 2) {
    Rprintf("  Edge flip results in left ");
...

{
...
#ifdef SELF_CHECK
  if (top.tri == m->dummytri) {
    Rprintf("Internal error in unflip():  Attempt to flip on boundary.\n");
    lnextself(*flipedge);
    return;
  }
  if (m->checksegments) {
    tspivot(*flipedge, toplsubseg);
    if (toplsubseg.ss != m->dummysub) {
      Rprintf("Internal error in unflip():  Attempt to flip a subsegment.\n");
      lnextself(*flipedge);
      return;
    }
  }
  ...
  if (b->verbose > 2) {
    Rprintf("  Edge unflip results in left ");
    printtriangle(m, b, flipedge);
    Rprintf("  and right ");
    printtriangle(m, b, &top);
  }
...

{
  ...
  if ((intersect == ONEDGE) || (intersect == OUTSIDE)) {
    ...
    if (counterclockwise(m, b, rightvertex, leftvertex, botvertex) < 0.0) {
      Rprintf("Internal error in insertvertex():\n");
      Rprintf(
    ...
    if (mirrorflag) {
      if (counterclockwise(m, b, leftvertex, rightvertex, topvertex) < 0.0) {
        Rprintf("Internal error in insertvertex():\n");
        Rprintf("  Clockwise triangle prior to edge vertex insertion (top).\n");
      }
...
#endif /* SELF_CHECK */
    if (b->verbose > 2) {
      Rprintf("  Updating bottom left ");
      printtriangle(m, b, &botright);
      if (mirrorflag) {
        Rprintf("  Updating top left ");
        printtriangle(m, b, &topright);
        Rprintf("  Creating top right ");
        printtriangle(m, b, &newtopright);
      }
      Rprintf("  Creating bottom right ");
    ...
    if (counterclockwise(m, b, rightvertex, leftvertex, botvertex) < 0.0) {
      Rprintf("Internal error in insertvertex():\n");
      Rprintf("  Clockwise triangle prior to vertex insertion.\n");
    }
    if (counterclockwise(m, b, rightvertex, leftvertex, newvertex) < 0.0) {
      Rprintf("Internal error in insertvertex():\n");
      Rprintf("  Clockwise triangle after vertex insertion (top).\n");
    }
    if (counterclockwise(m, b, leftvertex, botvertex, newvertex) < 0.0) {
      Rprintf("Internal error in insertvertex():\n");
      Rprintf("  Clockwise triangle after vertex insertion (left).\n");
    }
    if (counterclockwise(m, b, botvertex, rightvertex, newvertex) < 0.0) {
      Rprintf("Internal error in insertvertex():\n");
      Rprintf("  Clockwise triangle after vertex insertion (right).\n");
    }
#endif /* SELF_CHECK */
    if (b->verbose > 2) {
      Rprintf("  Updating top ");
      printtriangle(m, b, &horiz);
      Rprintf("  Creating left ");
      printtriangle(m, b, &newbotleft);
      Rprintf("  Creating right ");
      printtriangle(m, b, &newbotright);
    }
  }
        ...
        if (doflip) {
          ...
          if (newvertex != (vertex) NULL) {
            if (counterclockwise(m, b, leftvertex, newvertex, rightvertex) <
                0.0) {
              Rprintf("Internal error in insertvertex():\n");
              Rprintf("  Clockwise triangle prior to edge flip (bottom).\n");
            }
...
/*
            if (counterclockwise(m, b, rightvertex, farvertex, leftvertex) <
                0.0) {
              Rprintf("Internal error in insertvertex():\n");
              Rprintf("  Clockwise triangle prior to edge flip (top).\n");
            }
*/
            if (counterclockwise(m, b, farvertex, leftvertex, newvertex) <
                0.0) {
              Rprintf("Internal error in insertvertex():\n");
              Rprintf("  Clockwise triangle after edge flip (left).\n");
            }
            if (counterclockwise(m, b, newvertex, rightvertex, farvertex) <
                0.0) {
              Rprintf("Internal error in insertvertex():\n");
              Rprintf("  Clockwise triangle after edge flip (right).\n");
            }
          }
#endif /* SELF_CHECK */
          if (b->verbose > 2) {
...

{
  ...
  if (b->verbose > 2) {
    Rprintf("  Triangulating interior polygon at edge\n");
    Rprintf("    (%.12g, %.12g) (%.12g, %.12g)\n", leftbasevertex[0],
  ...
  if (b->verbose > 2) {
    Rprintf("    Connecting edge to (%.12g, %.12g)\n", bestvertex[0],
           bestvertex[1]);
  }
  if (bestnumber > 1) {
...

{
  ...
  while (!otriequal(*deltri, countingtri)) {
    ...
    if (countingtri.tri == m->dummytri) {
      Rprintf("Internal error in deletevertex():\n");
      Rprintf("  Attempt to delete boundary vertex.\n");
      internalerror();
    }
#endif /* SELF_CHECK */
    edgecount++;
...

{
  ...
  if (b->verbose > 2) {
    Rprintf("  Creating base bounding ");
...

{
  ...
  if (b->verbose > 2) {
    Rprintf("  Triangulating %d vertices.\n", vertices);
  }
  if (vertices == 2) {
    ...
    divconqrecurse(m, b, &sortarray[divider], vertices - divider, 1 - axis,
                   &innerright, farright);
    if (b->verbose > 1) {
      Rprintf("  Joining triangulations with %d and %d vertices.\n", divider,
             vertices - divider);
    }
...

{
  ...
  if (b->verbose) {
    Rprintf("  Removing ghost triangles.\n");
  }
...

{
  ...
  if (b->verbose) {
    Rprintf("  Creating triangular bounding box.\n");
  }
...

{
  ...
  if (b->verbose) {
    Rprintf("  Removing triangular bounding box.\n");
  }
  /* Find a boundary triangle. */
...

{
  ...
  boundingbox(m, b);
  if (b->verbose) {
    Rprintf("  Incrementally inserting vertices.\n");
  }
  traversalinit(&m->vertices);
...

{
  ...
  if (b->verbose) {
    Rprintf("  Placing vertices in event heap.\n");
  }
  ...
  do {
    if (heapsize == 0) {
      Rprintf("Error:  Input vertices are all identical.\n");
      triexit(1);
    }
...
#else /* not REDUCED */
  if (!b->quiet) {
    Rprintf("Constructing Delaunay triangulation ");
    if (b->incremental) {
      Rprintf("by incremental method.\n");
    } else if (b->sweepline) {
      Rprintf("by sweepline method.\n");
    } else {
      Rprintf("by divide-and-conquer method.\n");
    }
  }
  if (b->incremental) {
...

{
  ...
  incorners = corners;
  if (incorners < 3) {
    Rprintf("Error:  Triangles must have at least 3 vertices.\n");
    triexit(1);
  }
  m->eextras = attribs;
#else /* not TRILIBRARY */
  ...
  if (elefile == (FILE *) NULL) {
    Rprintf("  Error:  Cannot access file %s.\n", elefilename);
    triexit(1);
  }
  ...
  if (*stringptr == '\0') {
    ...
    if (incorners < 3) {
      Rprintf("Error:  Triangles in %s must have at least 3 vertices.\n",
             elefilename);
      triexit(1);
    }
  }
  ...
  if (b->vararea) {
    ...
    if (areaelements != m->inelements) {
      Rprintf("Error:  %s and %s disagree on number of triangles.\n",
  ...
  while (triangleloop.tri != (triangle *) NULL) {
    ...
    for (j = 0; j < 3; j++) {
      ...
      if ((corner[j] < b->firstnumber) ||
        ...
        Rprintf("Error:  Triangle %ld has an invalid vertex index.\n",
               elementnumber);
        triexit(1);
      }
    }
    ...
    for (j = 0; j < 3; j++) {
      stringptr = findfield(stringptr);
      if (*stringptr == '\0') {
        Rprintf("Error:  Triangle %ld is missing vertex %d in %s.\n",
  ...
  if (b->poly) {
    if (b->verbose) {
      Rprintf("  Marking segments in triangulation.\n");
    }
    ...
    while (subsegloop.ss != (subseg *) NULL) {
      ...
      stringptr = findfield(stringptr);
      if (*stringptr == '\0') {
        Rprintf("Error:  Segment %ld has no endpoints in %s.\n", segmentnumber,
               polyfilename);
        triexit(1);
      } else {
      ...
      stringptr = findfield(stringptr);
      if (*stringptr == '\0') {
        Rprintf("Error:  Segment %ld is missing its second endpoint in %s.\n",
      ...
      for (j = 0; j < 2; j++) {
        if ((end[j] < b->firstnumber) ||
          ...
          Rprintf("Error:  Segment %ld has an invalid vertex index.\n", 
                 segmentnumber);
          triexit(1);
        }
      }
...

{
  ...
  while (leftflag) {
    ...
    onextself(*searchtri);
    if (searchtri->tri == m->dummytri) {
      Rprintf("Internal error in finddirection():  Unable to find a\n");
      Rprintf("  triangle leading from (%.12g, %.12g) to", startvertex[0],
             startvertex[1]);
      Rprintf("  (%.12g, %.12g).\n", searchpoint[0], searchpoint[1]);
      internalerror();
    }
...

{
  ...
  denom = ty * ex - tx * ey;
  if (denom == 0.0) {
    Rprintf("Internal error in segmentintersection():");
    Rprintf("  Attempt to find intersection of parallel segments.\n");
    internalerror();
  }
  ...
  if (success != SUCCESSFULVERTEX) {
    Rprintf("Internal error in segmentintersection():\n");
    Rprintf("  Failure to split a segment.\n");
    internalerror();
  }
  ...
  if ((leftvertex[0] == endpoint1[0]) && (leftvertex[1] == endpoint1[1])) {
    ...
    Rprintf("Internal error in segmentintersection():\n");
    Rprintf("  Topological inconsistency after splitting a segment.\n");
    internalerror();
  }
...

{
  ...
  if (b->verbose > 2) {
    Rprintf("Forcing segment into triangulation by recursive splitting:\n");
  ...
  if (success == DUPLICATEVERTEX) {
    if (b->verbose > 2) {
      Rprintf("  Segment intersects existing vertex (%.12g, %.12g).\n",
             newvertex[0], newvertex[1]);
    }
    ...
    if (success == VIOLATINGVERTEX) {
      if (b->verbose > 2) {
        Rprintf("  Two segments intersect at (%.12g, %.12g).\n",
               newvertex[0], newvertex[1]);
      }
      ...
      success = insertvertex(m, b, newvertex, &searchtri1, &brokensubseg,
                             0, 0);
      if (success != SUCCESSFULVERTEX) {
        Rprintf("Internal error in conformingedge():\n");
        Rprintf("  Failure to split a segment.\n");
        internalerror();
      }
    }
...

{
  ...
  if (b->verbose > 1) {
    Rprintf("  Connecting (%.12g, %.12g) to (%.12g, %.12g).\n",
  ...
  if (checkvertex != endpoint1) {
    ...
    if (locate(m, b, endpoint1, &searchtri1) != ONVERTEX) {
      ...
      Rprintf("  (%.12g, %.12g) in triangulation.\n",
             endpoint1[0], endpoint1[1]);
      internalerror();
    }
  }
...

{
  ...
  if (b->poly) {
    if (!b->quiet) {
      Rprintf("Recovering segments in Delaunay triangulation.\n");
    }
#ifdef TRILIBRARY
    ...
    if (m->insegments > 0) {
      makevertexmap(m, b);
      if (b->verbose) {
        Rprintf("  Recovering PSLG segments.\n");
      }
    }
    ...
    for (i = 0; i < m->insegments; i++) {
      ...
      stringptr = findfield(stringptr);
      if (*stringptr == '\0') {
        Rprintf("Error:  Segment %d has no endpoints in %s.\n",
      ...
      stringptr = findfield(stringptr);
      if (*stringptr == '\0') {
        Rprintf("Error:  Segment %d is missing its second endpoint in %s.\n",
               b->firstnumber + i, polyfilename);
        triexit(1);
      } else {
      ...
      if ((end1 < b->firstnumber) ||
        ...
        if (!b->quiet) {
          Rprintf("Warning:  Invalid first endpoint of segment %d in %s.\n",
                 b->firstnumber + i, polyfilename);
        }
      } else if ((end2 < b->firstnumber) ||
                 (end2 >= b->firstnumber + m->invertices)) {
        if (!b->quiet) {
          Rprintf("Warning:  Invalid second endpoint of segment %d in %s.\n",
                 b->firstnumber + i, polyfilename);
        }
      } else {
        ...
        if ((endpoint1[0] == endpoint2[0]) && (endpoint1[1] == endpoint2[1])) {
          if (!b->quiet) {
            Rprintf("Warning:  Endpoints of segment %d are coincident in %s.\n",
                   b->firstnumber + i, polyfilename);
          }
        } else {
  ...
  if (b->convex || !b->poly) {
    ...
    if (b->verbose) {
      Rprintf("  Enclosing convex hull with segments.\n");
    }
    markhull(m, b);
  }
}
...

{
  ...
  if (b->verbose) {
    Rprintf("  Marking concavities (external triangles) for elimination.\n");
  }
  /* Find a triangle handle on the hull. */
  hulltri.tri = m->dummytri;
  hulltri.orient = 0;
...

{
  ...
  if (b->verbose) {
    Rprintf("  Marking neighbors of marked triangles.\n");
  }
  ...
  while (virusloop != (triangle **) NULL) {
    ...
    if (b->verbose > 2) {
      ...
      Rprintf("    Checking (%.12g, %.12g) (%.12g, %.12g) (%.12g, %.12g)\n",
  ...
  if (b->verbose) {
    Rprintf("  Deleting marked triangles.\n");
  }
  ...
  while (virusloop != (triangle **) NULL) {
    ...
    for (testtri.orient = 0; testtri.orient < 3; testtri.orient++) {
      ...
      if (testvertex != (vertex) NULL) {
        ...
        if (killorg) {
          if (b->verbose > 1) {
            Rprintf("    Deleting vertex (%.12g, %.12g)\n",
...

{
    ...
    for (testtri.orient = 0; testtri.orient < 3; testtri.orient++) {
      ...
      if ((neighbor.tri != m->dummytri) && !infected(neighbor)
        ...
        if (b->verbose > 2) {
          ...
          Rprintf("    Marking (%.12g, %.12g) (%.12g, %.12g) (%.12g, %.12g)\n",
                 regionorg[0], regionorg[1], regiondest[0], regiondest[1],
                 regionapex[0], regionapex[1]);
        }
        /* Infect the neighbor. */
  ...
  if (b->verbose > 1) {
    Rprintf("  Unmarking marked triangles.\n");
  }
  traversalinit(&m->viri);
  virusloop = (triangle **) traverse(&m->viri);
  while (virusloop != (triangle **) NULL) {
...

{
  ...
  if (!(b->quiet || (b->noholes && b->convex))) {
    Rprintf("Removing unwanted triangles.\n");
    if (b->verbose && (holes > 0)) {
      Rprintf("  Marking holes for elimination.\n");
    }
  }
  ...
  if (regions > 0) {
    if (!b->quiet) {
      if (b->regionattrib) {
        if (b->vararea) {
          Rprintf("Spreading regional attributes and area constraints.\n");
        } else {
          Rprintf("Spreading regional attributes.\n");
        }
      } else { 
        Rprintf("Spreading regional area constraints.\n");
      }
    }
...
void precisionerror()
{
  Rprintf("Try increasing the area criterion and/or reducing the minimum\n");
  Rprintf("  allowable angle so that tiny triangles are not created.\n");
#ifdef SINGLE
  Rprintf("Alternatively, try recompiling me with double precision\n");
  Rprintf("  arithmetic (by removing \"#define SINGLE\" from the\n");
  Rprintf("  source file or \"-DSINGLE\" from the makefile).\n");
#endif /* SINGLE */
}
...

{
  ...
  "  Splitting subsegment (%.12g, %.12g) (%.12g, %.12g) at (%.12g, %.12g).\n",
        ...
        if (((newvertex[0] == eorg[0]) && (newvertex[1] == eorg[1])) ||
          ...
          Rprintf("Error:  Ran out of precision at (%.12g, %.12g).\n",
                 newvertex[0], newvertex[1]);
          Rprintf("I attempted to split a segment to a smaller size than\n");
          Rprintf("  can be accommodated by the finite precision of\n");
          Rprintf("  floating point arithmetic.\n");
          precisionerror();
          triexit(1);
        }
        ...
        if ((success != SUCCESSFULVERTEX) && (success != ENCROACHINGVERTEX)) {
          Rprintf("Internal error in splitencsegs():\n");
          Rprintf("  Failure to split a segment.\n");
          internalerror();
        }
        if (m->steinerleft > 0) {
...

{
  ...
  if (b->verbose) {
    Rprintf("  Making a list of bad triangles.\n");
  }
  traversalinit(&m->triangles);
  triangleloop.orient = 0;
  triangleloop.tri = triangletraverse(m);
...

{
  ...
  if (!deadtri(badotri.tri) && (borg == badtri->triangorg) &&
    ...
    if (b->verbose > 1) {
      Rprintf("  Splitting this triangle at its circumcenter:\n");
      Rprintf("    (%.12g, %.12g) (%.12g, %.12g) (%.12g, %.12g)\n", borg[0],
    ...
    if (errorflag) {
      if (b->verbose) {
        Rprintf("  The new vertex is at the circumcenter of triangle\n");
        Rprintf("    (%.12g, %.12g) (%.12g, %.12g) (%.12g, %.12g)\n",
               borg[0], borg[1], bdest[0], bdest[1], bapex[0], bapex[1]);
      }
      Rprintf("This probably means that I am trying to refine triangles\n");
      Rprintf("  to a smaller size than can be accommodated by the finite\n");
      Rprintf("  precision of floating point arithmetic.  (You can be\n");
      Rprintf("  sure of this if I fail to terminate.)\n");
      precisionerror();
    }
  }
}
...

{
  ...
  if (!b->quiet) {
    Rprintf("Adding Steiner points to enforce quality.\n");
  }
  /* Initialize the pool of encroached subsegments. */
  poolinit(&m->badsubsegs, sizeof(struct badsubseg), BADSUBSEGPERBLOCK,
           BADSUBSEGPERBLOCK, 0);
  if (b->verbose) {
    Rprintf("  Looking for encroached subsegments.\n");
  }
  /* Test all segments to see if they're encroached. */
  tallyencs(m, b);
  if (b->verbose && (m->badsubsegs.items > 0)) {
    Rprintf("  Splitting encroached subsegments.\n");
  }
  ...
  if ((b->minangle > 0.0) || b->vararea || b->fixedarea || b->usertest) {
    ...
    m->checkquality = 1;
    if (b->verbose) {
      Rprintf("  Splitting bad triangles.\n");
    }
  ...
  if (!b->quiet && b->conformdel && (m->badsubsegs.items > 0) &&
    ...
    if (m->badsubsegs.items == 1) {
      Rprintf("  one encroached subsegment, and therefore might not be truly\n"
             );
    } else {
      Rprintf("  %ld encroached subsegments, and therefore might not be truly\n"
             , m->badsubsegs.items);
    }
    Rprintf("  Delaunay.  If the Delaunay property is important to you,\n");
    Rprintf("  try increasing the number of Steiner points (controlled by\n");
    Rprintf("  the -S switch) slightly and try again.\n\n");
  }
}
...

{
  ...
  if (!b->quiet) {
    Rprintf("Adding vertices for second-order triangles.\n");
  }
...

{
  ...
  do {
    ...
    if (result == (char *) NULL) {
      Rprintf("  Error:  Unexpected end of file in %s.\n", infilename);
      triexit(1);
    }
...

{
  ...
  if (m->invertices < 3) {
    Rprintf("Error:  Input must have at least three input vertices.\n");
    triexit(1);
  }
  if (m->mesh_dim != 2) {
    Rprintf("Error:  Triangle only works with two-dimensional meshes.\n");
    triexit(1);
  }
  if (m->nextras == 0) {
    b->weighted = 0;
  ...
  for (i = 0; i < m->invertices; i++) {
    ...
    stringptr = findfield(stringptr);
    if (*stringptr == '\0') {
      Rprintf("Error:  Vertex %d has no x coordinate.\n", b->firstnumber + i);
      triexit(1);
    }
    x = (REAL) strtod(stringptr, &stringptr);
    stringptr = findfield(stringptr);
    if (*stringptr == '\0') {
      Rprintf("Error:  Vertex %d has no y coordinate.\n", b->firstnumber + i);
      triexit(1);
    }
  ...
  if (*holes > 0) {
    ...
    *hlist = holelist;
    for (i = 0; i < 2 * *holes; i += 2) {
      ...
      stringptr = findfield(stringptr);
      if (*stringptr == '\0') {
        Rprintf("Error:  Hole %d has no x coordinate.\n",
               b->firstnumber + (i >> 1));
        triexit(1);
      } else {
      ...
      stringptr = findfield(stringptr);
      if (*stringptr == '\0') {
        Rprintf("Error:  Hole %d has no y coordinate.\n",
               b->firstnumber + (i >> 1));
        triexit(1);
      } else {
    ...
    if (*regions > 0) {
      ...
      *rlist = regionlist;
      ...
      for (i = 0; i < *regions; i++) {
        ...
        stringptr = findfield(stringptr);
        if (*stringptr == '\0') {
          Rprintf("Error:  Region %d has no x coordinate.\n",
                 b->firstnumber + i);
          triexit(1);
        } else {
        ...
        stringptr = findfield(stringptr);
        if (*stringptr == '\0') {
          Rprintf("Error:  Region %d has no y coordinate.\n",
                 b->firstnumber + i);
          triexit(1);
        } else {
          regionlist[index++] = (REAL) strtod(stringptr, &stringptr);
...

{
  ...
  if (outfile == (FILE *) NULL) {
    Rprintf("  Error:  Cannot create file %s.\n", nodefilename);
    triexit(1);
  }
...
#ifdef TRILIBRARY
  if (!b->quiet) {
    Rprintf("Writing Voronoi vertices.\n");
  }
...

{
  ...
  Rprintf("Mesh quality statistics:\n\n");
  radconst = PI / 18.0;
  degconst = 180.0 / PI;
  for (i = 0; i < 8; i++) {
  ...
  Rprintf("  Smallest area: %16.5g   |  Largest area: %16.5g\n",
         smallestarea, biggestarea);
  Rprintf("  Shortest edge: %16.5g   |  Longest edge: %16.5g\n",
         shortest, longest);
  Rprintf("  Shortest altitude: %12.5g   |  Largest aspect ratio: %8.5g\n\n",
         minaltitude, worstaspect);

  Rprintf("  Triangle aspect ratio histogram:\n");
  Rprintf("  1.1547 - %-6.6g    :  %8d    | %6.6g - %-6.6g     :  %8d\n",
         ratiotable[0], aspecttable[0], ratiotable[7], ratiotable[8],
         aspecttable[8]);
  for (i = 1; i < 7; i++) {
    Rprintf("  %6.6g - %-6.6g    :  %8d    | %6.6g - %-6.6g     :  %8d\n",
           ratiotable[i - 1], ratiotable[i], aspecttable[i],
           ratiotable[i + 7], ratiotable[i + 8], aspecttable[i + 8]);
  }
  Rprintf("  %6.6g - %-6.6g    :  %8d    | %6.6g -            :  %8d\n",
         ratiotable[6], ratiotable[7], aspecttable[7], ratiotable[14],
         aspecttable[15]);
  Rprintf("  (Aspect ratio is longest edge divided by shortest altitude)\n\n");

  Rprintf("  Smallest angle: %15.5g   |  Largest angle: %15.5g\n\n",
         smallestangle, biggestangle);

  Rprintf("  Angle histogram:\n");
  for (i = 0; i < 9; i++) {
    Rprintf("    %3d - %3d degrees:  %8d    |    %3d - %3d degrees:  %8d\n",
...
{
  Rprintf("\nStatistics:\n\n");
  Rprintf("  Input vertices: %d\n", m->invertices);
  if (b->refine) {
    Rprintf("  Input triangles: %d\n", m->inelements);
  }
  if (b->poly) {
    Rprintf("  Input segments: %d\n", m->insegments);
    if (!b->refine) {
      Rprintf("  Input holes: %d\n", m->holes);
    }
  }

  Rprintf("\n  Mesh vertices: %ld\n", m->vertices.items - m->undeads);
  Rprintf("  Mesh triangles: %ld\n", m->triangles.items);
  Rprintf("  Mesh edges: %ld\n", m->edges);
  Rprintf("  Mesh exterior boundary edges: %ld\n", m->hullsize);
  if (b->poly || b->refine) {
    Rprintf("  Mesh interior boundary edges: %ld\n",
           m->subsegs.items - m->hullsize);
    Rprintf("  Mesh subsegments (constrained edges): %ld\n",
           m->subsegs.items);
  }
  Rprintf("\n");
  ...
  if (b->verbose) {
    ...
    Rprintf("Memory allocation statistics:\n\n");
    Rprintf("  Maximum number of vertices: %ld\n", m->vertices.maxitems);
    Rprintf("  Maximum number of triangles: %ld\n", m->triangles.maxitems);
    if (m->subsegs.maxitems > 0) {
      Rprintf("  Maximum number of subsegments: %ld\n", m->subsegs.maxitems);
    }
    if (m->viri.maxitems > 0) {
      Rprintf("  Maximum number of viri: %ld\n", m->viri.maxitems);
    }
    if (m->badsubsegs.maxitems > 0) {
      Rprintf("  Maximum number of encroached subsegments: %ld\n",
             m->badsubsegs.maxitems);
    }
    if (m->badtriangles.maxitems > 0) {
      Rprintf("  Maximum number of bad triangles: %ld\n",
             m->badtriangles.maxitems);
    }
    if (m->flipstackers.maxitems > 0) {
      Rprintf("  Maximum number of stacked triangle flips: %ld\n",
             m->flipstackers.maxitems);
    }
    if (m->splaynodes.maxitems > 0) {
      Rprintf("  Maximum number of splay tree nodes: %ld\n",
             m->splaynodes.maxitems);
    }
    Rprintf("  Approximate heap memory use (bytes): %ld\n\n",
    ...
    Rprintf("Algorithmic statistics:\n\n");
    if (!b->weighted) {
      Rprintf("  Number of incircle tests: %ld\n", m->incirclecount);
    } else {
      Rprintf("  Number of 3D orientation tests: %ld\n", m->orient3dcount);
    }
    Rprintf("  Number of 2D orientation tests: %ld\n", m->counterclockcount);
    if (m->hyperbolacount > 0) {
      Rprintf("  Number of right-of-hyperbola tests: %ld\n",
             m->hyperbolacount);
    }
    if (m->circletopcount > 0) {
      Rprintf("  Number of circle top computations: %ld\n",
             m->circletopcount);
    }
    if (m->circumcentercount > 0) {
      Rprintf("  Number of triangle circumcenter computations: %ld\n",
             m->circumcentercount);
    }
    Rprintf("\n");
  }
...

{
  ...
  if (!b.quiet) {
    gettimeofday(&tv2, &tz);
    if (b.refine) {
      Rprintf("Mesh reconstruction");
    } else {
      Rprintf("Delaunay");
    }
    Rprintf(" milliseconds:  %ld\n", 1000l * (tv2.tv_sec - tv1.tv_sec) +
  ...
  if (!b.quiet) {
    ...
    if (b.usesegments && !b.refine) {
      Rprintf("Segment milliseconds:  %ld\n",
...
#ifndef CDT_ONLY
    if (b.quality) {
      Rprintf("Quality milliseconds:  %ld\n",
  ...
  if (b.nonodewritten || (b.noiterationnum && m.readnodefile)) {
    if (!b.quiet) {
#ifdef TRILIBRARY
      Rprintf("NOT writing vertices.\n");
#else /* not TRILIBRARY */
      Rprintf("NOT writing a .node file.\n");
#endif /* not TRILIBRARY */
    }
  ...
  if (b.noelewritten) {
    if (!b.quiet) {
#ifdef TRILIBRARY
      Rprintf("NOT writing triangles.\n");
#else /* not TRILIBRARY */
      Rprintf("NOT writing an .ele file.\n");
#endif /* not TRILIBRARY */
    }
  } else {
#ifdef TRILIBRARY
  ...
  if (b.poly || b.convex) {
    ...
    if (b.nopolywritten || b.noiterationnum) {
      if (!b.quiet) {
#ifdef TRILIBRARY
        Rprintf("NOT writing segments.\n");
#else /* not TRILIBRARY */
        Rprintf("NOT writing a .poly file.\n");
#endif /* not TRILIBRARY */
      }
    } else {
#ifdef TRILIBRARY
  ...
  if (!b.quiet) {
    ...
    Rprintf("Total running milliseconds:  %ld\n",
